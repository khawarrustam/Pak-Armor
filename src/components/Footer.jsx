            ...
            <footer className="bg-black text-white pt-10 sm:pt-16 pb-6 relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 lg:gap-8 mb-8 sm:mb-12">
                        ...
                        <div className="flex flex-col items-center sm:items-start text-center sm:text-left space-y-4 sm:space-y-6">
                            <Link to="/" className="flex items-center gap-3 group">
                                ...
                                <div>
                                    <p className="font-black text-white text-sm uppercase tracking-wider">PAK ARMORING</p>
                                    <p className="text-brand-gold text-[0.5rem] tracking-[0.2em] uppercase">Armored Vehicles</p>
                                </div>
                            </Link>
                            <p className="text-brand-gray/40 text-xs sm:text-sm leading-relaxed max-w-xs">
                        ...
                        <div className="text-center sm:text-left">
                            <h3 className="text-brand-gold text-xs sm:text-sm font-bold tracking-[0.2em] uppercase mb-4 sm:mb-6">About Company</h3>
                            <ul className="space-y-2 sm:space-y-3">
                                {aboutLinks.map((link) => (
                                    <li key={link.name}>
                                        <Link to={link.path} className="text-brand-gray/50 hover:text-white text-xs sm:text-sm transition-colors hover:pl-2 duration-200">
                                            {link.name}
                                        </Link>
                                    </li>
                                ))}
                        ...
                        {/* Products */}
                        <div className="text-center sm:text-left">
                            <h3 className="text-brand-gold text-xs sm:text-sm font-bold tracking-[0.2em] uppercase mb-4 sm:mb-6">Products</h3>
                            <ul className="space-y-2 sm:space-y-3">
                        ...
                        {/* Office Address */}
                        <div className="text-center sm:text-left">
                            <h3 className="text-brand-gold text-xs sm:text-sm font-bold tracking-[0.2em] uppercase mb-4 sm:mb-6">Office Address</h3>
                            <div className="space-y-3 sm:space-y-4 text-brand-gray/50 text-xs sm:text-sm">
                                <div className="flex items-start gap-3 justify-center sm:justify-start">
                                    <MapPin size={16} className="text-brand-gold shrink-0 mt-0.5" />
                                    <span>Plot No. 2/2a, Survey 86, Sector 24, Main Korangi Creek Road, Karachi.</span>
                                </div>
                                <div className="flex items-center gap-3 justify-center sm:justify-start">
                                    <Phone size={16} className="text-brand-gold shrink-0" />
                                    <a href="tel:0321-2112777" className="hover:text-brand-gold transition-colors">0321-2112777</a>
                                </div>
                                <div className="flex items-center gap-3 justify-center sm:justify-start">
                                    <Mail size={16} className="text-brand-gold shrink-0" />
                                    <a href="mailto:info@pakarmoring.pk" className="hover:text-brand-gold transition-colors break-all">info@pakarmoring.pk</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="border-t border-white/10 pt-6 sm:pt-8 flex flex-col sm:flex-row justify-between items-center gap-3 sm:gap-4">
                        <p className="text-brand-gray/30 text-[0.6rem] sm:text-xs tracking-wider text-center sm:text-left">
                            © {currentYear} Pak Armoring (Pvt) Ltd. All rights reserved.
                        </p>
                        <div className="flex gap-4 sm:gap-6">
                            <Link to="/faqs" className="text-brand-gray/30 hover:text-brand-gold text-[0.6rem] sm:text-xs tracking-wider transition-colors">FAQs</Link>
                            <Link to="/contact" className="text-brand-gray/30 hover:text-brand-gold text-[0.6rem] sm:text-xs tracking-wider transition-colors">Contact</Link>
                            <Link to="/media" className="text-brand-gray/30 hover:text-brand-gold text-[0.6rem] sm:text-xs tracking-wider transition-colors">Media</Link>
                        </div>
                    </div>
                </div>
            </footer>
